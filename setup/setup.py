...
class SetupScript:
    ...
    def configure_sourccey_udev(self) -> bool:
        """Install persistent Sourccey hardware aliases."""
        return configure_sourccey_udev(
            project_root=self.project_root,
            print_status=self.print_status,
            print_success=self.print_success,
    ...
    def run(
        ...
        if self.is_raspberry_pi():
            setup_steps.append(self.configure_sourccey_udev())
