...
class BiSourcceyV3BetaLeader(Teleoperator):
    """
    [Bimanual Sourccey V3 Beta Leader Arms] designed by Vulcan
    """

    config_class = BiSourcceyV3BetaLeaderConfig
    name = "bi_sourccey_v3beta_leader"

    def __init__(self, config: BiSourcceyV3BetaLeaderConfig):
        ...
        self.right_arm = SourcceyV3BetaLeader(right_arm_config)
