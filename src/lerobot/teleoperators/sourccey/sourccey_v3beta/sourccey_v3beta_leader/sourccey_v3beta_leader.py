...
from .calibration_sourccey_v3beta_leader import SourcceyV3BetaLeaderCalibrator

logger = logging.getLogger(__name__)


class SourcceyV3BetaLeader(Teleoperator):
    """
    [Sourccey V3 Beta Teleoperator] designed by Vulcan
    """

    config_class = SourcceyV3BetaLeaderConfig
    name = "sourccey_v3beta_leader"

    def __init__(self, config: SourcceyV3BetaLeaderConfig):
        ...
        self.calibrator = SourcceyV3BetaLeaderCalibrator(self)
