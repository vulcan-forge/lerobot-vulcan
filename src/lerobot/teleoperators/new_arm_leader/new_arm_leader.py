...
from lerobot.robots.new_arm.new_arm import make_new_arm_motors
...
class NewArmLeader(Teleoperator):
    """Seven-DOF leader arm matching the New Arm follower joint layout."""

    config_class = NewArmLeaderConfig
    name = "new_arm_leader"

    def __init__(self, config: NewArmLeaderConfig):
