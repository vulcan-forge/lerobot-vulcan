...
class FeetechMotorsBus(SerialMotorsBus):
    ...
    def configure_motors(self, return_delay_time=0, maximum_acceleration=254, acceleration=254) -> None:
        for motor in self.motors:
            ...
            # This forces position readings to be in the range [0, resolution - 1] and avoids startup branch ambiguity.
            # Apply to all STS/SMS models (e.g. STS3215, STS3250).
            model = self.motors[motor].model
            if model.startswith("sts") or model.startswith("sms"):
