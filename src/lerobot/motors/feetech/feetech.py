...
class FeetechMotorsBus(SerialMotorsBus):
    ...
    def configure_motors(self, return_delay_time=0, maximum_acceleration=254, acceleration=254) -> None:
        for motor in self.motors:
            ...
            # This forces position readings to stay in the canonical [0, resolution - 1] branch.
            # Apply this consistently to every Feetech motor model exposing the Phase register.
