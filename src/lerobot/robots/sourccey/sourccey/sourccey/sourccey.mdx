...
python src/lerobot/scripts/lerobot_train.py \
 ...
 --policy.type=vulcan0 \
 --output_dir=outputs/train/vulcan0__sourccey-010__shirtfold-1-a__000__colinm- \
...
python src/lerobot/scripts/lerobot_train.py \
 --dataset.repo_id=sourccey-010/sourccey-010__shirtfold-1-a__000__colinm \
 --policy.type=act \
 --output_dir=outputs/train/act__sourccey-010__shirtfold-1-a__000__colinm \
 --job_name=act__sourccey-010__shirtfold-1-a__000__colinm \
 --policy.device=cuda \
 --wandb.enable=false \
 --steps=10000 \
 --save_freq=10000 \
