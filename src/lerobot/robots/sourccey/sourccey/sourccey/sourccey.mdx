...
python lerobot/scripts/train.py \
  ...
  --policy.type=act \
  --output_dir=outputs/train/act__so100_follower-001__dataset-a__set000 \
  --job_name=act__so100_follower-001__dataset-a__set000 \
  --policy.device=cuda \
  --wandb.enable=false \
  --steps=20000
```
...
python src/lerobot/scripts/combine_dataset.py \
    --repo_ids local/sourccey-001__ai_test_4 local/sourccey-001__ai_test_4 \
    --output_repo_id=local/sourccey-001__ai_test_4_combined \
    --push_to_hub=0
```
