...
python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id=sourccey-004/sourccey-003__tape-cup__myles__combined-2  \
  --policy.type=act \
  --output_dir=outputs/train/act__sourccey-003__tape-cup__myles__combined-2 \
  --job_name=act__sourccey-003__tape-cup__myles__combined-2  \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=200000 \
...
python src/lerobot/datasets/combine_dataset/combine_dataset.py \
    ...
    --output_path='sourccey-004/sourccey-003__tape-cup__myles__combined-2'
```
