...
python src/lerobot/scripts/sourccey/auto_calibrate.py \
 ...
 --teleop.left_arm_port="COM13" \
 --teleop.right_arm_port="COM12"
```
...
python src/lerobot/control/sourccey/sourccey/record.py \
 ...
 --dataset.task="Take the item out of the printer" \
 --dataset.fps=30 \
...
python src/lerobot/scripts/lerobot_train.py \
 ...
 --job_name=act__sourccey-008__counter-a__set000__name \
 --policy.device=cuda \
 --wandb.enable=false \
 --steps=100000 \
 --save_freq=20000 \
...
```
python src/lerobot/scripts/lerobot_train.py \
 --dataset.repo_id=sourccey-010/sourccey-010__shirtfold-1-a__000__colinm \
 --policy.type=vulcan0 \
 --output_dir=outputs/train/vulcan0__sourccey-010__shirtfold-1-a__000__colinm-2 \
 --job_name=vulcan0__sourccey-010__shirtfold-1-a__000__colinm-2 \
 --policy.device=cuda \
 --wandb.enable=false \
 --steps=10000 \
 --save_freq=10000 \
...
python src/lerobot/scripts/lerobot_train.py \
 --dataset.repo_id=sourccey-010/sourccey-010__shirtfold-1-a__000__colinm \
 --policy.type=act \
 --output_dir=outputs/train/act__sourccey-010__shirtfold-1-a__000__colinm-2 \
 --job_name=act__sourccey-010__shirtfold-1-a__000__colinm-2 \
 --policy.device=cuda \
 --wandb.enable=false \
 --steps=10000 \
 --save_freq=10000 \
...
python src/lerobot/control/sourccey/sourccey/evaluate.py \
 --id="sourccey" \
 --remote_ip="192.168.1.230" \
 --model_path="outputs/train/act__sourccey-008__counter-a__set000__name/checkpoints/020000/pretrained_model" \
 --dataset.repo_id="sourccey-008/eval_sourccey-008__counter-a__set000__name" \
 --dataset.num_episodes=1 \
...
python src/lerobot/control/sourccey/sourccey/evaluate.py \
 --id="sourccey" \
 --remote_ip="192.168.1.210" \
 --model_path="outputs/train/vulcan0__sourccey-010__shirtfold-1-a__000__colinm/checkpoints/010000/pretrained_model" \
 --dataset.repo_id="sourccey-010/eval_vulcan0__sourccey-010__shirtfold-1-a__000__colinm" \
 --dataset.num_episodes=1 \
 --dataset.episode_time_s=60 \
 --dataset.reset_time_s=5 \
 --dataset.task="Fold the towel" \
...
python src/lerobot/control/sourccey/sourccey/replay.py \
 --id="sourccey" \
 --remote_ip="192.168.1.230" \
 --dataset.dataset="sourccey-008/sourccey-008__counter-a__set000__name" \
 --dataset.episode=0
 --dataset.fps=30
```
...
python src/lerobot/scripts/sourccey/combine_datasets.py \
 --dataset_paths='[
"sourccey-008/sourccey-008__counter-a__set000__name",
"sourccey-008/sourccey-008__counter-a__set001__name",
]' \
 --output_path="sourccey-008/sourccey-008__counter-a__set000-combined__name"
```
