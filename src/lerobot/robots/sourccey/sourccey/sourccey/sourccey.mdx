...
python -m lerobot.auto_calibrate \
  ...
  --teleop.left_arm_port="COM15" \
  --teleop.right_arm_port="COM14"
```
...
python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id=sourccey-004/sourccey-003__tape-cup__myles__combined-3  \
  --policy.type=act \
  --output_dir=outputs/train/act__sourccey-003__tape-cup__myles__combined-3 \
  --job_name=act__sourccey-003__tape-cup__myles__combined-3  \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=200000 \
...
torchrun --nproc_per_node=2 src/lerobot/scripts/train.py \
  --dataset.repo_id=local/sourccey-003__tape-cup-1-10__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__sourccey-003__tape-cup-1-10__combined \
  --job_name=act__sourccey-003__tape-cup-1-10__combined  \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=300000 \
...
```bash
python src/lerobot/datasets/combine_dataset/combine_dataset.py \
    --dataset_paths='[
      "sourccey-004/sourccey-003__tape-cup-1__myles", 
      "sourccey-004/sourccey-003__tape-cup-2__myles",
      "sourccey-004/sourccey-003__tape-cup-3__myles",
      "sourccey-004/sourccey-003__tape-cup-4__myles",
      "sourccey-004/sourccey-003__tape-cup-5__myles",
      "sourccey-004/sourccey-003__tape-cup-6__myles",
      "sourccey-004/sourccey-003__tape-cup-7__myles",
      "sourccey-004/sourccey-003__tape-cup-8__myles",
      "sourccey-004/sourccey-003__tape-cup-9__myles",
      "sourccey-004/sourccey-003__tape-cup-10__myles"
    ]' \
    --output_path='sourccey-004/sourccey-003__tape-cup__myles__combined-3'
```
