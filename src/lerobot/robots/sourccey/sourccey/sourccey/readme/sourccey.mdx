...
python src/lerobot/scripts/sourccey/calibration/auto_calibrate.py \
 ...
 --teleop.left_arm_port="COM24" \
 --teleop.right_arm_port="COM25"
```
...
python src/lerobot/control/sourccey/sourccey/record.py \
 ...
 --right_arm_port="COM25" \
 --reverse=True \
 --dataset.repo_id="sourccey-009/sourccey-009__shirt-fold-a__set006__colinm" \
...
```
LEROBOT_DISABLE_SDPA=1 python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id=sourccey-012/sourccey-012__shirt-fold__cmb__0003__chrism \
  --policy.path="lerobot/xvla-base" \
  --output_dir=outputs/train/xvla__sourccey-012__shirt-fold__cmb__0003__chrism_puregray \
  --job_name=xvla__sourccey-012__shirt-fold__cmb__0003__chrism_puregray \
  --policy.device=cuda \
