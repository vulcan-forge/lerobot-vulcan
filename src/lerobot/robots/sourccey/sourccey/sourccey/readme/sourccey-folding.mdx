...
uv run lerobot-record \
 ...
 --teleop_keyboard.type=keyboard \
 --teleop_keyboard.id="sourccey_keyboard" \
 --dataset.repo_id="sourccey-013/nickm/sourccey-013__pile-shirt-fold-a/sourccey-013__pile-shirt-fold-a__red__set040__nickm" \
 --dataset.num_episodes=5 \
 --dataset.episode_time_s=300 \
 --dataset.reset_time_s=5 \
 --dataset.single_task="Grab a shirt from the pile, fold it, then place the folded shirt to the side." \
 --dataset.fps=30 \
 --display_data=true \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --dataset.repo_id="Combination/sourccey-shirt-fold-c-009-subset-215-pile-shirt-fold-a-001" \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-009-subset-215-pile-shirt-fold-a-001" \
  --job_name="xvla_s_sourccey-shirt-fold-c-009-subset-215-pile-shirt-fold-a-001" \
...
#Fine tune FAST VERSION
```
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --dataset.repo_id="Combination/sourccey-shirt-fold-c-009" \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-009-test" \
  --job_name="xvla_s_sourccey-shirt-fold-c-009" \
  ...
  --batch_size=8 \
  --wandb.enable=false \
  --policy.resize_imgs_with_padding='[160,160]' \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  ...
  --job_name="xvla_light_sourccey-shirt-fold-c-009" \
...
CUDA_VISIBLE_DEVICES=0 uv run lerobot-train-retry \
  ...
  --output_dir="outputs/train/xvla_light_sourccey-shirt-fold-c-009-cached-001" \
  --job_name="xvla_light_sourccey-shirt-fold-c-009-cached" \
  ...
  --policy.florence_cache_path="outputs/cache/xvla-light-c-009-florence.sqlite"
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  ...
  --dataset.repo_id="Combination/sourccey-shirt-fold-c-009" \
  --dataset.image_transforms.enable=false \
  --output_dir="outputs/train/xvla_extra_light_sourccey-shirt-fold-c-009-cached" \
  --job_name="xvla_extra_light_sourccey-shirt-fold-c-009-cached" \
  --policy.path="outputs/converted/xvla-extra-light-sourccey-shirt-fold-c-009/checkpoints/1000000/pretrained_model" \
  --policy.dtype=bfloat16 \
  --policy.action_mode=auto \
  --policy.max_action_dim=20 \
  --policy.device=cuda \
