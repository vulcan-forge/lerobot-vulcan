...
uv run lerobot-record \
 ...
 --teleop_keyboard.id="sourccey_keyboard" \
<<<<<<< HEAD
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-fold-blue-c-specific/sourccey-013__shirt-fold-blue-c-specific-010/nickm/sourccey-013__shirt-fold-blue-c__set009__nickm" \
 --dataset.num_episodes=1 \
||||||| 29a99b275
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-fold-blue-c/nickm/sourccey-013__shirt-fold-blue-c__set450__nickm" \
 --dataset.num_episodes=1 \
=======
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-fold-blue-c-specific/sourccey-013__shirt-fold-blue-c-specific-012/nickm/sourccey-013__shirt-fold-blue-c__set001__nickm" \
...
CUDA_VISIBLE_DEVICES=1 python src/lerobot/scripts/lerobot_train_retry.py \
  ...
  --job_name="xvla_s_sourccey-shirt-fold-c-008" \
