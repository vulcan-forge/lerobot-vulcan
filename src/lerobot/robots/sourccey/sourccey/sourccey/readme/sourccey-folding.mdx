...
uv run lerobot-record \
 ...
 --teleop_keyboard.type=keyboard \
 --teleop_keyboard.id="sourccey_keyboard" \
 --dataset.repo_id="sourccey-013/nickm/sourccey-013__shirt-fold-blue-c/sourccey-013__shirt-fold-blue-c__set501_nickm" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --dataset.repo_id="Combination/sourccey-shirt-fold-c-009-subset-060-pile-shirt-fold-a-000" \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-009-subset-060-pile-shirt-fold-a-000" \
  --job_name="xvla_s_sourccey-shirt-fold-c-009-subset-060-pile-shirt-fold-a-000" \
