...
CUDA_VISIBLE_DEVICES=0 uv run lerobot-train-retry \
  ...
  --policy.path="outputs/train/xvla_s_sourccey-shirt-fold-c-005/checkpoints/1000000/pretrained_model" \
  --policy.dtype=bfloat16 \
  --policy.action_mode=auto \
  --policy.max_action_dim=20 \
  --policy.device=cuda \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  ...
  --save_freq=20000 \
  --resume=true \
  --config_path="outputs/train/xvla_s_sourccey-shirt-fold-c-004/checkpoints/last/pretrained_model/train_config.json"
