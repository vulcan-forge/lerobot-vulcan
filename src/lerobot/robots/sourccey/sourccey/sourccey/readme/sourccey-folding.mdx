...
uv run lerobot-record \
 ...
 --teleop.left_arm_port="/dev/ttyACM0" \
 --teleop.right_arm_port="/dev/ttyACM1" \
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-fold-light-blue-c/nickm/sourccey-013__shirt-fold-light-blue-c__set002_nickm" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --dataset.repo_id="Combination/sourccey-shirt-fold-c-006" \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-006-2" \
  --job_name="xvla_s_sourccey-shirt-fold-c-006" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-006" \
  --steps=1000000 \
  --save_freq=20000 \
  --resume=true \
  --config_path="outputs/train/xvla_s_sourccey-shirt-fold-c-006/checkpoints/last/pretrained_model/train_config.json"
