...
uv run lerobot-record \
 ...
 --teleop.left_arm_port="/dev/ttyACM0" \
 --teleop.right_arm_port="/dev/ttyACM1" \
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-fold-blue-c/nickm/sourccey-013__shirt-fold-blue-c__set450__nickm" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  ...
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-004" \
  --job_name="xvla_s_sourccey-shirt-fold-c-004" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-fold-c-003" \
  --steps=1000000 \
  --save_freq=20000 \
  --resume=true \
  --config_path="outputs/train/xvla_s_sourccey-shirt-fold-c-003/checkpoints/last/pretrained_model/train_config.json"
