...
uv run lerobot-record \
 ...
 --teleop.left_arm_port="/dev/ttyACM0" \
 --teleop.right_arm_port="/dev/ttyACM1" \
 --dataset.repo_id="sourccey-013/sourccey-013__shirt-place-a/nickm/sourccey-013__shirt-place-a__set008_nickm" \
 --dataset.num_episodes=25 \
 --dataset.episode_time_s=300 \
 --dataset.reset_time_s=5 \
 --dataset.single_task="Place the folded shirt to the side" \
 --dataset.fps=30 \
 --display_data=true \
...
CUDA_VISIBLE_DEVICES=1 python src/lerobot/scripts/lerobot_train_retry.py \
  ...
  --dataset.repo_id="Combination/sourccey-shirt-place-a-000" \
  --output_dir="outputs/train/xvla__sourccey-shirt-place-a-000" \
  --job_name="xvla__sourccey-shirt-grab-a-000" \
...
CUDA_VISIBLE_DEVICES=0 uv run lerobot-train-retry \
  ...
  --retry-delay-seconds=20 \
  --dataset.repo_id="Combination/sourccey-shirt-place-a-000" \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-place-a-000-start-c-006" \
  --job_name="xvla_s_sourccey-shirt-place-a-000" \
...
CUDA_VISIBLE_DEVICES=1 uv run lerobot-train-retry \
  --max-attempts=30 \
  --retry-delay-seconds=20 \
  --output_dir="outputs/train/xvla_s_sourccey-shirt-grab-a-000-start-c-006" \
  --steps=1000000 \
  --save_freq=20000 \
  --resume=true \
  --config_path="outputs/train/xvla_s_sourccey-shirt-grab-a-000-start-c-006/checkpoints/last/pretrained_model/train_config.json"
