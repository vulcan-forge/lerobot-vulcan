...
python src/lerobot/control/sourccey/sourccey/record.py \
 ...
 --right_arm_port="/dev/ttyACM1" \
 --reverse=True \
 --dataset.repo_id="sourccey-012/sourccey-012__shorts-fold-e__set019__mylesr" \
...
python src/lerobot/scripts/lerobot_train.py \
 --resume=true \
 --config_path=outputs/train/xact__sourccey-009__arm-left-a__set000__nick/checkpoints/last/pretrained_model/train_config.json \
 --dataset.repo_id=sourccey-009/sourccey-009__arm-left-a__set000__nick \
 --policy.path="lerobot/xvla-base" \
 --output_dir=outputs/train/xvla__sourccey-012__shirt-fold__cmb__0013__chrism \
 --job_name=xvla__sourccey-012__shirt-fold__cmb__0013__chrism \
 --policy.device=cuda \
 --policy.train_soft_prompts=true \
 --policy.dtype=float32 \
 --policy.action_mode=auto \
...
### Adding-New-Data command Single GPU Training

```
python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id=sourccey-012/combine/jeans/0007/sourccey-012__jeans-fold-2__cmb__0003__chrism \
  --policy.path="outputs/train/xvla__sourccey-012__jeans-fold__cmb__0006__chrism/checkpoints/200000/pretrained_model" \
  --output_dir=outputs/train/xvla__sourccey-012__jeans-fold__cmb__0007__chrism \
  --job_name=xvla__sourccey-012__jeans-fold__cmb__0007__chrism \
  --policy.device=cuda \
  --policy.train_soft_prompts=true \
  --policy.dtype=float32 \
  --policy.action_mode=auto \
...
python src/lerobot/control/sourccey/sourccey/evaluate.py \
 --id="sourccey" \
 --remote_ip="192.168.1.214" \
 --model_path="outputs/train/xvla__sourccey-009-012__shorts-fold__cmb__003__mylesr/checkpoints/300000/pretrained_model" \
 --dataset.repo_id="sourccey-012/eval_sourccey-009-012__shorts-fold__cmb__003__mylesr" \
...
python src/lerobot/scripts/sourccey/datset/combine_datasets.py \
 --dataset_paths='[
