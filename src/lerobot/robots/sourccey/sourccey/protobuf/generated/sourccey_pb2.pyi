...
class SourcceyRobotAction(_message.Message):
    __slots__ = ("left_arm_target_joints", "right_arm_target_joints", "base_target_velocity", "untorque_all")
    ...
    UNTORQUE_ALL_FIELD_NUMBER: _ClassVar[int]
    left_arm_target_joints: MotorJoint
    right_arm_target_joints: MotorJoint
    base_target_velocity: BaseVelocity
    untorque_all: bool
    def __init__(self, left_arm_target_joints: _Optional[_Union[MotorJoint, _Mapping]] = ..., right_arm_target_joints: _Optional[_Union[MotorJoint, _Mapping]] = ..., base_target_velocity: _Optional[_Union[BaseVelocity, _Mapping]] = ..., untorque_all: bool = ...) -> None: ...
