...
class SourcceyFollowerConfig(RobotConfig):
    ...
    gripper_fully_closed_threshold: float = 8.0
    ...
    gripper_nominal_max_torque_limit: int = 900
    gripper_nominal_protection_current: int = 700
    # Slightly stronger limits used only while squeezing near closed position.
    gripper_squeeze_max_torque_limit: int = 1400
    gripper_squeeze_protection_current: int = 1100
