...
python src/lerobot/scripts/combine_dataset.py \
    --repo_ids local/sourccey_v3beta-001__ai_test_4 local/sourccey_v3beta-001__ai_test_4 \
...
python src/lerobot/scripts/train.py \
  --dataset.repo_id=local/sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined \
  --policy.type=act \
  --output_dir=outputs/train/act__sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined \
  --job_name=act__sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined \
  --policy.device=cuda \
  --save_freq=20000 \
  --policy.push_to_hub=false \
  --wandb.enable=false \
