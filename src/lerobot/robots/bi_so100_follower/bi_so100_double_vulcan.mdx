...
python src/lerobot/scripts/combine_dataset.py \
    --repo_ids local/act__sourccey-001__ai_test_6_shoulder-fast_chrism local/sourccey-001__ai_test_6_shoulder-fast_chrism_2 \
    --output_repo_id=local/sourccey-001__ai_test_6_shoulder-fast_chrism_combined \
    --push_to_hub=0
