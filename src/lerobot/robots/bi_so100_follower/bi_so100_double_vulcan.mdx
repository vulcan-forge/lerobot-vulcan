...
python src/lerobot/teleoperate.py \
    ...
    --robot.left_arm_port=/dev/robotLeft \
    --robot.right_arm_port=/dev/robotRight \
    --robot.id=bi_so100_follower-001 \
    --robot.cameras="{ left: {type: opencv, index_or_path: /dev/cameraLeft, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: /dev/cameraRight, width: 640, height: 480, fps: 30}}" \
    --teleop.type=bi_so100_leader \
    --teleop.left_arm_port=/dev/teleopLeft \
    --teleop.right_arm_port=/dev/teleopRight \
    --teleop.id=bi_so100_leader-001 \
    --display_data=true
```
...
python -m lerobot.record \
    ...
    --robot.right_arm_port=/dev/robotRight \
    --robot.id=bi_so100_follower-001 \
    --robot.cameras="{ left: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 2, width: 640, height: 480, fps: 30}}" \
    --teleop.type=bi_so100_leader \
    --teleop.left_arm_port=/dev/teleopLeft \
    --teleop.right_arm_port=/dev/teleopRight \
    --teleop.id=bi_so100_leader-001 \
    --dataset.repo_id=local/so100_double-001__towel-e__set003__TEST \
    --dataset.num_episodes=10 \
    --dataset.single_task="Grab the towel and fold it" \
    --dataset.push_to_hub=false
```

```bash
python lerobot/scripts/train.py \
  --dataset.repo_id=local/so100_double-001__towel-4a-2b-4c-2d__set000__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__so100_double-001__towel-4a-2b-4c-2d__set000__combined \
  --job_name=act__so100_double-001__towel-4a-2b-4c-2d__set000__combined \
  --policy.device=cuda \
  --wandb.enable=false \
...
torchrun --nproc_per_node=2 lerobot/scripts/train.py \
 --dataset.repo_id=local/so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined \
 --policy.type=act \
 --policy.device=cuda \
 --output_dir=outputs/train/act__so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined \
 --job_name=act__so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined \
 --wandb.enable=false \
 --policy.push_to_hub=false \
 --steps=50000 \
 --batch_size=32 \
...
```bash
python lerobot/scripts/train.py \
  --dataset.repo_id=local/so100_double-001__towel-2a-2b__set000__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__so100_double-towel-2a-2b__set000__combined \
  --job_name=act__so100_double-towel-2a-2b__set000__combined \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=100000 \
  --config_path="outputs/train/act__so100_double-towel-2a-2b__set000__combined/checkpoints/060000/pretrained_model/train_config.json" \
  --resume=true
```

```bash
CUDA_VISIBLE_DEVICES=1 python lerobot/scripts/train.py \
  --dataset.repo_id=local/so100_double-001__towel-3e__set000__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__so100_double-001__towel-3e__set000__combined \
  --job_name=act__so100_double-001__towel-3e__set000__combined \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=20000
...
python -m lerobot.record  \
  ...
  --robot.right_port=/dev/robotRight \
  --robot.cameras="{ left: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 2, width: 640, height: 480, fps: 30}}" \
  --policy.path="outputs/train/act__so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined/checkpoints/050000/pretrained_model" \
  --dataset.repo_id=local/eval__so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined \
...
python lerobot/scripts/combine_dataset.py \
    --repo_ids local/so100_double-001__towel-a__set000__mylesr local/so100_double-001__towel-a__set001__mylesr local/so100_double-001__towel-a__set002__mylesr local/so100_double-001__towel-a__set003__mylesr local/so100_double-001__towel-b__set000__mylesr local/so100_double-001__towel-b__set001__mylesr local/so100_double-001__towel-c__set000__mylesr local/so100_double-001__towel-c__set001__mylesr local/so100_double-001__towel-c__set002__mylesr local/so100_double-001__towel-c__set003__mylesr local/so100_double-001__towel-d__set000__mylesr local/so100_double-001__towel-d__set001__mylesr local/so100_double-001__towel-d__set002__mylesr local/so100_double-001__towel-d__set003__mylesr local/so100_double-001__towel-e__set000__mylesr local/so100_double-001__towel-e__set001__mylesr local/so100_double-001__towel-e__set002__mylesr local/so100_double-001__towel-g__set002__mylesr local/so100_double-001__towel-g__set003__mylesr local/so100_double-001__towel-g__set004__mylesr local/so100_double-001__towel-g__set005__mylesr local/so100_double-001__towel-i__set000__mylesr local/so100_double-001__towel-i__set001__mylesr local/so100_double-001__towel-i__set002__mylesr local/so100_double-001__towel-i__set003__mylesr \
    --output_repo_id=local/so100_double-001__towel-4a-2b-4c-4d-3e-4g-4i__set000__combined \
    --push_to_hub=0
...
lerobot-teleoperate \
    ...
    --robbashot.id=double_so100_follower \
    --robot.cameras="{ front: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}, side: {type: opencv, index_or_path: 2, width: 640, height: 480, fps: 30}}" \
    --teleop.type=so100_double_leader \
    --teleop.left_port=COM13 \
    --telbasheop.right_port=COM14 \
...
python src/lerobot/scripts/combine_dataset.py \
    --repo_ids local/act__sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism local/sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_2 \
    --output_repo_id=local/sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined \
    --push_to_hub=0
...
python -m lerobot.teleoperate \
    --robot.type=bi_so100_follower \
    --robot.left_arm_port=COM8 \
	--robot.right_arm_port=COM9 \
    --robot.id=bi_so100_follower \
    --teleop.type=bi_so100_leader \
    --teleop.left_arm_port=COM3 \
	--teleop.right_arm_port=com29 \
	--robot.cameras="{ left: {type: opencv, index_or_path: 1, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}}" \
...
python -m lerobot.record \
	...
	--teleop.right_arm_port=com29 \
    --teleop.id=bi_so100_leader \
    --dataset.repo_id=local/bi_so100_test_01 \
    --dataset.num_episodes=10 \
    --dataset.single_task="Grab the tape and drop it in the cup" \
    --dataset.push_to_hub=false
