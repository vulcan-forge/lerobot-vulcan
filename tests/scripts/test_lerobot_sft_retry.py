...
from lerobot.scripts.lerobot_sft_retry import main as sft_retry_main
from lerobot.scripts.lerobot_train_retry import _extract_output_dir


def test_sft_retry_targets_lerobot_sft_module():
    with patch("lerobot.scripts.lerobot_sft_retry.retry_main", return_value=0) as retry_main:
