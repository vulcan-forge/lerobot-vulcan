...
def test_recovery_pathing_inserts_backoff_then_tuck_when_stalled():
    ...
    backoff_goal = planner.apply_recovery_pathing(goal_pos, present_pos)
    assert backoff_goal == {
        "shoulder_pan": 3.0,
        "shoulder_lift": 3.0,
        "elbow_flex": 3.0,
    ...
    tucked_goal = planner.apply_recovery_pathing(goal_pos, present_pos)
    assert tucked_goal == {
        "shoulder_pan": 1.0,
        "shoulder_lift": 1.0,
        "elbow_flex": 1.0,
