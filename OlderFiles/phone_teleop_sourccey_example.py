...
def main():
    ...
    if sourccey_model_path.exists():
        ...
        print("Make sure the Sourccey V3 Beta model files are available in src/lerobot/robots/sourccey/sourccey_v2beta/model/")
        return
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                action_left = phone_teleop.get_action(observation)
                ...
                action = {
                    "shoulder_pan.pos":  mir(action_left.get("left_shoulder_pan.pos", 0.0),  neutral[0], r[0]),
                    "shoulder_lift.pos": mir(action_left.get("left_shoulder_lift.pos", 0.0), neutral[1], r[1]),
                    "elbow_flex.pos":    mir(action_left.get("left_elbow_flex.pos", 0.0),    neutral[2], r[2]),
                    "wrist_flex.pos":    mir(action_left.get("left_wrist_flex.pos", 0.0),    neutral[3], r[3]),
                    "wrist_roll.pos":    mir(action_left.get("left_wrist_roll.pos", 0.0),    neutral[4], r[4]),
                    # Gripper typically not mirrored
                    "gripper.pos":       float(action_left.get("left_gripper.pos", 0.0)),
                }
