...
policy = ACTPolicy.from_pretrained("outputs/train/act__sourccey_v3beta-001__ai_test_4/checkpoints/020000/pretrained_model")
...
dataset = LeRobotDataset.create(
    repo_id="local/eval_act__sourccey_v3beta-001__ai_test_4",
    fps=FPS,
