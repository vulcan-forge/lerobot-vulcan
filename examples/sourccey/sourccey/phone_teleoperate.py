...
"""
Phone Teleoperation for Sourccey V1 Robot (Right Arm Only)

This script demonstrates how to integrate phone teleoperation with the Sourccey V1 robot,
...
- Connect your Sourccey V1 robot via network (client connection)

Usage:
1. Start the Sourccey V1 host on the Raspberry Pi:
   uv run -m lerobot.robots.sourccey.sourccey_v1.sourccey_v1.sourccey_v1_host

2. Run this script on your computer:
   python examples/sourccey/sourccey_v1/phone_teleoperate.py
...
def main():
    ...
    phone_config = PhoneTeleoperatorSourcceyConfig(
        ...
        # Rest pose for Sourccey V1 right arm (conservative middle position in radians)
    ...
    _init_rerun(session_name="sourccey_phone_teleop")
    ...
    print("Phone teleoperation ready for Sourccey (Right Arm Only)!")
