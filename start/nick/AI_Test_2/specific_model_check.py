...
def main():
    ...
    dataset_directory = r"C:\Users\Nicholas\.cache\huggingface\lerobot\local\ai_test_2\data\chunk-000"
    frame_index = 100 # Start with first frame
    ...
    try:
        ...
        policy_path = "outputs/train/act__ai_test_2/checkpoints/020000/pretrained_model"
