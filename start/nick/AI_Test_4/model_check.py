...
def main():
    ...
    dataset_directory = r"C:\Users\Nicholas\.cache\huggingface\lerobot\local\sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined\data\chunk-000"
    frame_index = 160 # Start with first frame
    ...
    try:
        ...
        policy_path = "outputs/train/act__sourccey_v3beta-001__ai_test_6_shoulder-fast_chrism_combined/checkpoints/040000/pretrained_model"
