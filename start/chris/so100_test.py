...
def main():
    ...
    dataset_directory = r"C:\Users\Theor\.cache\huggingface\lerobot\local\bi_so100_test_02\data\chunk-000"
    ...
    try:
        ...
        # We also need to get the action associated with that observation
        action = dataset.actions[frame_index]
        logger.info(f"Loaded action: {action}")
        ...
        policy_path = "outputs/train/act__bi_so100_test_02/checkpoints/020000/pretrained_model"
